...
<% if (options.lang) { %>
import <%= options.lang %> from '~/lang/validate-locale/<%= options.lang %>'
<% } %>
    ...
    app.validator = VeeValidate.Validator
        ...
        if (nuxti18n && app.i18n) {
            ...
            if (app.validator.locale !== validatorLocale) {
                import(`~~/lang/validate-locale/${validatorLocale}`).then(dic => {
            ...
            app.i18n.beforeLanguageSwitch = (oldLocale, newLocale) => {
                ...
                import(`~~/lang/validate-locale/${newValidatorLocale}`).then(dic => {
